#!/usr/bin/env python3
"""
Script to plot term1-4 factor decomposition (Mass × Policy × Quality).
"""
import argparse

from plot_paper_figures import plot_diagnose_figure

if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Plot term factor decomposition")
    parser.add_argument(
        "experiment_names",
        type=str,
        nargs="+",
    ...
    parser.add_argument(
        "--output_filename",
        type=str,
        default="term_factor_decomposition.png",
        help="Output filename (default: term_factor_decomposition.png)",
    )
    parser.add_argument(
        "--captions",
        type=str,
