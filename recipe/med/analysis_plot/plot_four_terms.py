#!/usr/bin/env python3
"""
Script to plot four-term decomposition.
"""
import argparse

from plot_paper_figures import plot_four_term_decomposition

if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Plot four-term decomposition")
    parser.add_argument(
        "experiment_names",
        type=str,
        nargs="+",
    ...
    parser.add_argument(
        "--output_filename",
        type=str,
        default="s1_s4_decomposition.png",
        help="Output filename (default: s1_s4_decomposition.png)",
    )
    parser.add_argument(
        "--captions",
        type=str,
