#!/usr/bin/env python3
"""
Script to plot term1-4 decomposition.
"""
import argparse

from plot_paper_figures import plot_term_decomposition

if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Plot term1-4 decomposition")
    parser.add_argument(
        "experiment_names",
        type=str,
        nargs="+",
    ...
    parser.add_argument(
        "--output_filename",
        type=str,
        default="term1_term4_decomposition.png",
        help="Output filename (default: term1_term4_decomposition.png)",
    )
    parser.add_argument(
        "--captions",
        type=str,
