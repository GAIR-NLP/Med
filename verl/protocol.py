...
__all__ = ["DataProto", "union_tensor_dict", "DataProtoItem"]
...
class DataProto:
    ...
    def from_single_dict(
        ...
        return cls.from_dict(
            tensors=tensors, non_tensors=non_tensors, meta_info=meta_info, auto_padding=auto_padding
        )
    ...
    def select_idxs(self, idxs):
        ...
        return type(self)(
            batch=selected_batch, non_tensor_batch=selected_non_tensor, meta_info=self.meta_info
        )
    ...
    def slice(self, start=None, end=None, step=None):
        ...
        return type(self)(
            batch=sliced_batch, non_tensor_batch=sliced_non_tensor, meta_info=self.meta_info
        )
