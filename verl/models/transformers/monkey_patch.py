...
def patch_forward_with_backends(
    ...
    if model.config.model_type in ["qwen2_5_vl", "qwen2_vl"]:
        ...
        forward_with_torch_backend_function = forward_with_torch_backend
        forward_with_triton_backend_function = forward_with_triton_backend
    elif model.config.model_type == "glm46v":
        from verl.models.transformers.glm46v import (
            forward_with_torch_backend,
            forward_with_triton_backend,
        )
...
def apply_monkey_patch(
    ...
    if model.config.model_type in ["qwen2_5_vl", "qwen2_vl"]:
        ...
        from transformers.models.glm46v.modeling_glm46v import (
            Glm46VForConditionalGeneration as Glm4vForConditionalGeneration,
        )
        from transformers.models.glm46v.modeling_glm46v import Glm46VModel as Glm4vModel

        from verl.models.transformers.glm46v import forward_with_normal_backend, glm4v_base_forward
        ...
        # Step 2: patch attention to support ulysses parallelism
        if use_remove_padding or ulysses_sp_size > 1:
            from verl.models.transformers.glm46v import glm4v_attn_forward
